...
def train(hyp, opt, device, tb_writer=None):
    ...
    if opt.adam:
        ...
        optimizer = optim.SGD(pg0, lr=0.001, momentum=hyp['momentum'], nesterov=True)
        ...
        if (epoch+1) %10 == 0:
            ...
            if rank in [-1, 0]:
                ...
                if save:
                    ...
                    if epoch >= (epochs-30) or (epoch+1) % 10==0:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--norm', action='store_true', help='normalize contrast head')
    parser.add_argument('--Affine', action='store_true', help='Affine Augmentation')
    parser.add_argument('--Flip', action='store_true', help='Flip Augmentation')
