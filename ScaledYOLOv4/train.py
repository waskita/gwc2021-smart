...
def train(hyp, opt, device, tb_writer=None):
    ...
    epochs, batch_size, total_batch_size, weights, rank, seed = \
        opt.epochs, opt.batch_size, opt.total_batch_size, opt.weights, opt.global_rank, opt.seed
        ...
        if (epoch+1) %10 == 0:
            ...
            if rank in [-1, 0]:
                ...
                if save:
                    ...
                    #if (epoch+1) == 150 or (epoch+1) == 200 or (epoch+1) == 250 or (epoch+1) == 300:
                    if (epoch+1) % 10 == 0:
