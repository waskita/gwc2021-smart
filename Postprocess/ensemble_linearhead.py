...
if __name__ == '__main__':
    model1_csvpath = '../ScaledYOLOv4_linearhead/inference/output/linearhead_pseudo30.csv'
    model2_csvpath = '../ScaledYOLOv4_linearhead/inference/output/linearhead_pseudo50.csv'
    model3_csvpath = '../ScaledYOLOv4_linearhead/inference/output/linearhead_pseudo100.csv'
    #savepath = ''
    ...
    for index, row in model1_df.iterrows():
        ...
        if len(mixBoxes) != 0:
            final_box, _ = box_fusion(mixBoxes, 1024, iou_thresh=0.6, num=1)
        else:
            final_box = ''
    ...
    #save csv
    file_out_path = 'linearhead_ensemble.csv'
