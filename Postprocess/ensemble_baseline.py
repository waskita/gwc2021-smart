...
if __name__ == '__main__':
    model1_csvpath = '../ScaledYOLOv4/inference/output/baseline_pseudo30.csv'
    model2_csvpath = '../ScaledYOLOv4/inference/output/baseline_pseudo50.csv'
    model3_csvpath = '../ScaledYOLOv4/inference/output/baseline_pseudo100.csv'
    #savepath = ''
    ...
    #save csv
    file_out_path = 'baseline_ensemble.csv'
